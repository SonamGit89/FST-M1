...
public class Activity6 {
    ...
    public void chromeTest() {
        ...
        wait.until(ExpectedConditions.numberOfElementsToBe(AppiumBy.className("android.widget.Image"),4));
        driver.findElement(AppiumBy.androidUIAutomator(UiScrollable + ".scrollForward()"));
        wait.until(ExpectedConditions.numberOfElementsToBe(AppiumBy.className("android.widget.Image"),5));
